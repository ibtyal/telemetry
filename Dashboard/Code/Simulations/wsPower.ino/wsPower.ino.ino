...
void setup() {
  ...
  Serial.println("WiFi enlazado, conectando a Websocket.");
   // Intentará conectarse al websoecket
  bool connected = client.connect(websockets_server_host, websockets_server_port, "/uri");
  if(connected) {
   Serial.println("Connectado!");
  } else {
      Serial.println("No Connectado!");
  }
}
